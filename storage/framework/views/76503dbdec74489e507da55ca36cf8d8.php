...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0"><i class="bi bi-list-ul"></i> Completed Projects</h5>
    </div>
    <div class="card-body">
        ...
        <?php else: ?>
            <div class="text-center py-5">
                ...
                <p class="text-muted mt-3">No projects have been completed yet.</p>
            </div>
        <?php endif; ?>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\nihar\Desktop\udaan_events\resources\views/admin/projects/completed.blade.php ENDPATH**/ ?>